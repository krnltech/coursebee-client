  ...
  const [summary, setSummary] = useState([
    {
      ...
      body: "আমাদের মান সম্মত পাঠ্যক্রমটি ইন্ডাস্ট্রির চাহিদার সাথে মিল রেখে তৈরি করা হয়েছে,  তাই শীর্ষ সংস্থাগুলি আপনার কাছে  যে  দক্ষতাগুলি চায় তা শিখে নিন ",
    ...
    },
    {
      ...
      body: "রিয়েল-ওয়ার্ল্ড প্রকল্পগুলি এবং অন্যান্য হ্যান্ড-অন অনুশীলনগুলি দিয়ে শিখুন যা সত্যিকারের দক্ষতা অর্জনে সহায়তা করে",
    ...
    },
    {
      ...
      body: "সেলফ বেসড লার্নিং - যখনই এবং যেখানেই আপনি চান, কোর্সের রিসোর্স ব্যবহার করুন",
